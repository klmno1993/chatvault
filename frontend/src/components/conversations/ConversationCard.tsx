    ...
    >
      ...
      <div className="pl-1">
        ...
        <div className="flex items-start justify-between gap-2 mb-1.5">
          <h3 className="text-[13.5px] font-semibold leading-snug line-clamp-2 flex-1 tracking-tight text-[var(--text-primary)]">
            {conversation.title}
          </h3>
          {conversation.isStarred && (
            <Star size={12} className="flex-shrink-0 mt-0.5 fill-[var(--accent)] text-[var(--accent)]" />
          )}
        </div>

        {/* Row 2: summary */}
        {conversation.summary && (
          <p className="text-[12.5px] text-[var(--text-tertiary)] line-clamp-2 leading-relaxed mb-2.5">
            {conversation.summary}
          </p>
        )}
